{{-- resources/views/admin/publishers/create.blade.php --}}
@extends('admin.layouts.app')

@section('title', __('admin.add_new_publisher'))
@section('page-title', __('admin.add_new_publisher'))
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="address" rows="3" 
                              class="form-input w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                    @error('address')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
